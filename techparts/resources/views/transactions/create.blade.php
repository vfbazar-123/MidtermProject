...
@section('title', 'Create Transaction - MyStore')

@section('content')
<div class="container-fluid px-3 px-md-5 mt-4">
	<div class="row mb-4">
		<div class="col">
			<h1 style="color: #EE4D2D; font-weight: 700;">➕ Create New Transaction</h1>
		</div>
		<div class="col text-end">
			<a href="{{ route('transactions.index') }}" class="btn btn-secondary" style="background-color: #6c757d; border: none;">
					...
					<form action="{{ route('transactions.store') }}" method="POST">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control @error('reference_number') is-invalid @enderror" 
								   ...
								   placeholder="e.g., CHK001, INV-2025-001" style="border: 1px solid #ddd;">
						...
						<div class="mb-3">
							...
							<textarea class="form-control @error('description') is-invalid @enderror" 
									  ...
									  placeholder="Add transaction details..." style="border: 1px solid #ddd;">{{ old('description') }}</textarea>
							@error('description')
								<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
